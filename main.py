...
async def on_ready():
    ...
    for guild in client.guilds:
        ...
        n_servers+=1
    await client.change_presence(activity=discord.Activity(type=discord.ActivityType.playing, name=f" codewars.com | Active in {n_servers} servers"))#Set the presence
...
async def on_guild_join(guild):
    ...
    embedVar.add_field(name="Invite me", value=f"Use {PREFIX}invite to invite me to your server", inline=False)
    ...
    for channel in range(len(guild.text_channels)):
        try:
